...
<head>
	...
	<link rel="icon" type="image/png" href="public/favicon/favicon-192x192.png" sizes="192x192">
	...
	<!-- Fonts -->
	<link href="public/fonts/webfont-raleway/webfont-raleway.css" rel="stylesheet" type="text/css">
	<link href="public/fonts/webfont-font-awesome/css/font-awesome.css" rel="stylesheet" type="text/css">

	<!-- Stylesheets -->
	<link href="public/css/global.css" type="text/css" rel="stylesheet" media="all">
...
<body>
	...
	<!-- Scripts postload -->
	<script src="public/js/dependencies.min.js" type="text/javascript"></script>
